...
hist(log(dataC$meanAGC), breaks = 20)
hist(log(dataC$meanSC))

shapiro.test(log(dataC$meanAGC))
shapiro.test(log(dataC$meanSC))
...
res.kruskal <- kruskal_test(log(meanAGC) ~ ID_AF, data = dataC)
res.kruskal
