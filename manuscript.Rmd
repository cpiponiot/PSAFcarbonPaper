...
# organic carbon content that decreases as a negative exponential of depth, 
# we can deduce the carbon content at 10-20 cm with the following function: 
# SOC[10-20] = SOC[0-10]*sqrt(SOC[20-30]/SOC[0-10])
data_soil <- merge(
  data_soil,
  data_soil[
    , .(
...
data_sim_soil <- data_soil[
  , .(
    # 10% error on fine soil mass
    mfine = c(Sample_DRY, rnorm(1000, Sample_DRY, Sample_DRY * 0.1)), 
    # 12% error on C content measurement
    Corg = c(Corg, rnorm(1000, Corg, Corg * 0.12)), 
