...
Soil organic carbon stocks (in Mg\ C\ ha$^{-1}$) were then calculated using the method recommended by @Poeplau2017 (M4), which correctly takes into account the coarse fraction of the soil:
...
## Lack of relationship between soil and biomass carbon [Vincent]

- Low correlation between NPP and SOC in tropical soils [ref: Sayer et al. (2019).  Tropical forest soil carbon stocks do not increase despite 15 years of doubled litter inputs.]

- Functioning of AFS is similar to that of a tropical forest

Some AFS have high SOC for reasons other than the presence of trees; e.g. effect of cattle in SP systems. 

## Perspectives: quantify biodiversity in these AFS [Marguerite]

importance of ecological continuity - a range of biodiversity (plant/animal/micro-organisms) that can develop in these traditional AF systems: plots of less than 1ha, density + distribution of trees (intra- and inter-plot), multi-strata. 

perspectives: quantify other indicators, such as biodiversity and composition, not only for plants but also for other groups such as animals and micro-organisms; These other organisms are as important as trees in carbon storage [ref?] 
...
```{r fig.id = "barplot", fig.height = 5, fig.width = 6, fig.cap = "Barplot of the amount of carbon in each AFS (CF: crop and fallow, SP: silvopastoral, YA: young agroforest, HG: home garden, FG: forest garden), per site. AGC: Aboveground (biomass) carbon; BGC: belowground (biomass) carbon; SOC: soil organic carbon."}
## reorder factors 
